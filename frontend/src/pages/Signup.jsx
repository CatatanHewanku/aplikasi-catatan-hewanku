...
export default function SignUp(){
    ...
    return(
      <Flex minH="100vh" bg="Primary.100" justify="center" align="center" px="20px" py="70px">
        <Box position="relative" bg="white" w="100%" maxW="380px" minH="700px" borderRadius="30px" px="28px" pt="65px" boxShadow="lg" pb="40px" >
        ...
        <Flex align="center" direction="column">
          <Button mt="40px" w="80%" h="40px" bg="Primary.800" color="Neutral.100" borderRadius="30px" fontFamily="body" fontSize="xl" fontWeight="medium" boxShadow="md" _hover={{ opacity: 0.9 }} onClick={handleSignUp}>
            Sign Up
          </Button>
